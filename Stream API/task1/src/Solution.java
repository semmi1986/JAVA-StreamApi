...
public class Solution {
    ...
    public static void main(String[] args) {
        ...
        Task task2 = new Task(2, "Read Java 8 Lambdas book", TaskType.READING, LocalDate.of(2015, Month.JULY, 25)).addTag("java8").addTag("reading").addTag("books");
        Task task3 = new Task(3, "Write a mobile application to store my tasks", TaskType.CODING, LocalDate.of(2015, Month.JULY, 2)).addTag("coding").addTag("mobile");
    ...
    private static List<String> allReadingTasks(List<Task> tasks) {
        return tasks.stream()
                ...
                .sorted(Comparator.comparing(Task::getCreatedOn)) // Сортировка задач по дате создания
                .map(Task::getTitle) // Преобразование задач в их заголовки
